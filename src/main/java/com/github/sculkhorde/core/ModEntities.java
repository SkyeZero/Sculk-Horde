...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<CursorTopDownInfectorEntity>> CURSOR_TOP_DOWN_INFECTOR = ENTITY_TYPES.register("cursor_top_down_infector", () -> EntityType.Builder.<CursorTopDownInfectorEntity>of(CursorTopDownInfectorEntity::new, MobCategory.MISC).sized(1f, 1f).clientTrackingRange(4).updateInterval(10).build("cursor_top_down_infector"));
    public static final RegistryObject<EntityType<CursorTopDownPurifierEntity>> CURSOR_TOP_DOWN_PURIFIER = ENTITY_TYPES.register("cursor_top_down_purifier", () -> EntityType.Builder.<CursorTopDownPurifierEntity>of(CursorTopDownPurifierEntity::new, MobCategory.MISC).sized(1f, 1f).clientTrackingRange(4).updateInterval(10).build("cursor_top_down_purifier"));
